                    ...
                    <div class="cadastro mt-4">
                        ...
                        <div class="d-flex justify-content-start gap-4">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="usuarios_tipo" id="usuarios_tipo1" value="pessoa_fisica" checked onclick="mostrar('pf')">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="usuarios_tipo" id="usuarios_tipo2" value="pessoa_juridica" onclick="mostrar('pj')">
                        ...
                        <div id="form-pf" class="col-md-12 mt-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mt-4 mb-2">
                                    ...
                                    <input type="text" name="pf_nome" id="pf_nome" placeholder="Digite seu primeiro nome" class="form-control" value="<?= $_POST['pf_nome'] ?? '' ?>" required>
                                </div>

                                <div class="col-md-6 mt-4 mb-2">
                                    <label for="pf_sobrenome">Sobrenome </label>
                                    <input type="text" name="pf_sobrenome" id="pf_sobrenome" placeholder="Digite seu sobrenome" class="form-control" value="<?= $_POST['pf_sobrenome'] ?? '' ?>" required>
                                </div>

                                <div class="col-md-6 mt-4 mb-2">
                                    <label for="pf_dataNascimento">Data de nascimento </label>
                                    <input type="date" name="pf_dataNascimento" id="pf_dataNascimento" class="form-control" value="<?= $_POST['pf_dataNascimento'] ?? '' ?>" required>
                                </div>
                                ...
                                <div class="col-md-6 mt-4 mb-2">
                                    ...
                                    <input type="text" name="pf_cpf" id="pf_cpf" placeholder="Digite seu CPF" class="form-control cpf" value="<?= $_POST['pf_cpf'] ?? '' ?>" required>
                                </div>

                                <div class="col-md-6 mt-4 mb-2">
                                    <label for="usuarios_telefone">Telefone/Celular</label>
                                    <input type="tel" name="usuarios_telefone" id="usuarios_telefone_pf" placeholder="Digite seu telefone" class="form-control tel" value="<?= $_POST['usuarios_telefone'] ?? '' ?>" required>
                                </div>

                                <div class="col-md-6 mt-4 mb-2">
                                    <label for="usuarios_email">Email</label>
                                    <input type="email" name="usuarios_email" id="usuarios_email_pf" placeholder="Digite seu email" class="form-control" value="<?= $_POST['usuarios_email'] ?? '' ?>" required>
                                </div>
                                ...
                                <div class="col-md-6 mt-4 mb-2">
                                    ...
                                    <input type="text" name="endereco_rua" id="endereco_rua_pf" placeholder="Digite sua rua" class="form-control" value="<?= $_POST['endereco_rua'] ?? '' ?>" required>
                                </div>

                                <div class="col-md-6 mt-4 mb-2">
                                    <label for="endereco_bairro">Bairro </label>
                                    <input type="text" name="endereco_bairro" id="endereco_bairro_pf" placeholder="Digite seu bairro" class="form-control" value="<?= $_POST['endereco_bairro'] ?? '' ?>" required>
                                </div>

                                <div class="col-md-6 mt-4 mb-2">
                                    <label for="endereco_complemento">Complemento </label>
                                    <input type="text" name="endereco_complemento" id="endereco_complemento_pf" placeholder="Apto, Bloco, Quadra, Etc..." class="form-control" value="<?= $_POST['endereco_complemento'] ?? '' ?>" required>
                                </div>

                                <div class="col-md-6 mt-4 mb-2">
                                    <label for="endereco_numero">Número </label>
                                    <input type="text" name="endereco_numero" id="endereco_numero_pf" placeholder="Número da residência" class="form-control" value="<?= $_POST['endereco_numero'] ?? '' ?>" required>
                                </div>
                                ...
                                <div class="col-md-6 mt-4 mb-2">
                                    ...
                                    <input type="text" name="endereco_nome" id="endereco_nome_pf" placeholder="Ex. Minha loja/Minha casa" class="form-control" required value="<?= $_POST['endereco_nome'] ?? '' ?>">
                                </div>


                                <div class="col-md-6 mt-4 mb-2">
                                    <label for="endereco_cidade">Cidade </label>
                                    <input type="text" name="endereco_cidade" id="endereco_cidade_pf" placeholder="Digite sua cidade" class="form-control" value="<?= $_POST['endereco_cidade'] ?? '' ?>" required>
                                </div>
                                ...
                                <div class="col-md-12 mt-4 mb-2">
                                    ...
                                    <textarea name="endereco_descricao" id="endereco_descricao" placeholder="Descreva a localização (opcional)" class="form-control" value="<?= $_POST['endereco_descricao'] ?? '' ?>"></textarea>

                                </div>

                                <div class="botoes col-md-6 ms-auto mt-5 mb-4">
                                    <input type="reset" class="btn-reset" value="Limpar Formulário">
                                    <input type="submit" name="enviarPessoaFisica" class="btn-submit" value="Finalizar Cadastro">
                                </div>
                        ...
                        <div id="form-pj" style="display:none" class="cold-md-12 mt-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mt-4 mb-2">
                                    ...
                                    <input type="date" name="pj_dataFundacao" id="pj_dataFundacao" value="<?= $_POST['pj_dataFundacao'] ?? '' ?>" class="form-control" required>
                                </div>
                                ...
                                <div class="col-md-6 mt-4 mb-2">
                                    <label for="endereco_nome">Titulo endereco </label>
                                    <input type="text" name="endereco_nome" id="endereco_nome" placeholder="Ex. Minha loja" class="form-control" required value="<?= $_POST['endereco_nome'] ?? '' ?>">
                                </div>
                                ...
                                <div class="botoes col-md-6 ms-auto mt-5 mb-4">
                                    <input type="reset" class="btn-reset" value="Limpar Formulário">
                                    <input type="submit" name="enviarPessoaJuridica" class="btn-submit" value="Finalizar Cadastro">
                                </div>
